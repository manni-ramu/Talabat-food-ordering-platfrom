...
export const getAllCartItems = (reqData) => {
    return async (dispatch) => {
        ...
        try {
            const response = await api.get(`/api/cart/${reqData.cardId}/items`, {
                headers: {
...
export const clearCartAction = (jwt) => {
    return async (dispatch) => {
        ...
        try {
            ...
            dispatch({ type: CLEARE_CART_REQUEST, payload: data });
        } catch (error) {
