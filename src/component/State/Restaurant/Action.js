...
export const getRestaurantById = (reqData) => {
    return async (dispatch) => {
        ...
        try {
            ...
            console.log("all restaurant by id ", response.data);
        } catch (error) {
            console.log("catch error ", error)
...
export const deleteEventAction = ({ eventId, jwt }) => {
    return async (dispatch) => {
        ...
        try {
            ...
            console.log("deleete events", res.data);
...
export const getRestaurantsEvents = ({ restaurantId, jwt }) => {
    return async (dispatch) => {
        ...
        try {
            ...
            console.log("get rest events", res.data);
...
export const getRestaurantCategory = ({ jwt, restaurantId }) => {
    return async (dispatch) => {
        ...
        try {
            const res = await api.get(`/api/admin/category/restauran/`,
                res.data,
                {
                    headers: {
                        Authorization: `Bearer ${jwt}`,
